...
def setup_logger(
    log_level: str = "INFO", log_file: Optional[str] = None, console: bool = True
) -> logging.Logger:
    """Set up the logger.
...
def log_error(message: str, extra_info: Optional[str] = None) -> None:
...
class LogCapture:
    ...
    def __enter__(self) -> "LogCapture":
        """Set up log capture."""
        handler = CaptureHandler(self.captured_logs, self.level)
...
class CaptureHandler(logging.Handler):
    ...
    def __init__(self, records: List[Dict[str, Any]], level: int):
