...
class Scanner:
    ...
    def scan(self, symbols: List[str], strategies: List[str] = None) -> Dict[str, List[str]]:
        """
        ...
        log_info(f"Scan completed in {scan_time:.2f} seconds. Found signals for {len(signals)} symbols")
        
        return signals
        
    def scan_with_go_service(self, symbols: List[str], strategies: List[str]) -> Dict[str, List[str]]:
        """
    ...
    def scan_locally(self, symbols: List[str], strategy_ids: List[str]) -> Dict[str, List[str]]:
        """
            ...
            try:
                ...
                for strategy in strategies:
                    ...
                    for signal_type, signal_symbol in strategy_signals:
                        if signal_symbol == symbol and signal_type not in symbol_signals:
