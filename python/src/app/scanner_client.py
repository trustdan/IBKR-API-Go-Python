...
class ScannerClient:
    ...
    def scan(self, symbols: List[str], strategies: List[str]) -> Dict[str, List[str]]:
        ...
        """
        try:
            log_debug(f"Scanning {len(symbols)} symbols with {len(strategies)} strategies")
    ...
    def bulk_fetch(self, symbols: List[str], timeframe: str) -> Dict[str, bytes]:
        ...
        """
        try:
            log_debug(f"Bulk fetching {len(symbols)} symbols with timeframe {timeframe}")
...
class DummyScannerStub:
    ...
    def Scan(self, symbols, strategies):
    ...
    def BulkFetch(self, symbols, timeframe):
