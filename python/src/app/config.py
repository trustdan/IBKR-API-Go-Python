...
class Config:
    ...
    MAX_SECTOR_EXPOSURE: float = 0.30  # Maximum exposure to a single sector (30% of portfolio)
    MAX_INDUSTRY_EXPOSURE: float = 0.20  # Maximum exposure to a single industry (20% of portfolio)
    ...
    API_REQUEST_WARNING_THRESHOLD: float = 1.0  # API request warning threshold in seconds
    API_REQUEST_CRITICAL_THRESHOLD: float = 5.0  # API request critical threshold in seconds
    OPTION_SELECTION_WARNING_THRESHOLD: float = 2.0  # Option selection warning threshold in seconds
    OPTION_SELECTION_CRITICAL_THRESHOLD: float = 10.0  # Option selection critical threshold in seconds
    ORDER_EXECUTION_WARNING_THRESHOLD: float = 2.0  # Order execution warning threshold in seconds
    ORDER_EXECUTION_CRITICAL_THRESHOLD: float = 5.0  # Order execution critical threshold in seconds
    DATA_PROCESSING_WARNING_THRESHOLD: float = 1.0  # Data processing warning threshold in seconds
    DATA_PROCESSING_CRITICAL_THRESHOLD: float = 5.0  # Data processing critical threshold in seconds
    ...
    MEMORY_WARNING_THRESHOLD: float = 80.0  # Memory usage warning threshold in percentage
    MEMORY_CRITICAL_THRESHOLD: float = 95.0  # Memory usage critical threshold in percentage
    ...
    CIRCUIT_BREAKER_THRESHOLD: int = 5  # Number of errors before tripping circuit breaker
    ...
    ALERT_LEVELS: List[str] = None  # Will be set in __post_init__
    SEVERITY_CHANNELS: Dict[str, List[str]] = None  # Will be set in __post_init__
    USE_EMAIL_ALERTS: bool = True
    USE_SMS_ALERTS: bool = False
    USE_SLACK_ALERTS: bool = True
    
    # Email Alert Settings
    EMAIL_SETTINGS: Dict[str, Any] = None  # Will be set in __post_init__
    
    # SMS Alert Settings
    SMS_SETTINGS: Dict[str, Any] = None  # Will be set in __post_init__
    
    # Slack Alert Settings
    SLACK_SETTINGS: Dict[str, Any] = None  # Will be set in __post_init__
